...
ON w.headwaiter = z.headwaiter
WHERE z.first_name = 'Zoe' AND z.surname = 'Ball' AND w.staff_no != z.staff_no;
...
ON s.staff_no = rm.headwaiter OR s.headwaiter = rm.headwaiter
